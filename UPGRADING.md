...
**`v0.17.0` was tagged at the wrong commit and is identical to `v0.16.1` — install `v0.17.1` or later to get the changes described below.** See the [CHANGELOG](CHANGELOG.md#v0171---2026-07-06) for what happened.
