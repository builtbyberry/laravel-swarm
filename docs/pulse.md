...
The [Laravel Pulse](https://laravel.com/docs/pulse) integration — recorders and dashboard cards for swarm runs, step durations, memory growth, and audit outbox observability — has moved to a companion package as of v0.17.0:
...
If you were referencing `BuiltByBerry\LaravelSwarm\Pulse\*` classes directly before v0.17.0, see [UPGRADING.md](../UPGRADING.md) for the migration steps.
