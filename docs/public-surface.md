...
| `swarm:install:pulse` | Register the Swarm Pulse recorders + dashboard cards. Refuses gracefully when `laravel/pulse` is not installed. Flags: `--cards=runs,steps,audit-outbox`, `--force`. (v0.8.0+) | [Pulse](pulse.md) |
