 ...
 *   it (resolved through the parent map). The course-corrected view a consumer
 *   renders by default.
 * - Everything — nothing is suppressed. Voided events are surfaced as
 *   {@see VoidedEvent} wrappers that carry the void type and reason, for an
 *   audit/debug view of the full history including retracted work.
 */
